...
Semantic HTML creates structure for your webpage. It is similar to the walls of a house.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
Block means that elements are displayed on top of each other, while inline means they could be displayed next to each other. In block has some space between the two elements.
3. What are the 4 areas of the box model?
content, padding, border, and margin
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
along cross-axis.
5. Explain why git is valuable to a team of developers.
Git is valuable, because one can create branches of code to help create a project. Also easy way to share code.
